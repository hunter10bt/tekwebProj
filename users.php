...
<body>
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <?php
          if(!isset($_SESSION["uname"])){
            ...
            echo "<a class='nav-link' href='signin.php?prevPage=users.php'>Sign In</a>";
            echo '</li>';
            
            echo '<li class="nav-item">';
            echo "<a class='nav-link' href='signup.php?prevPage=users.php'>Sign Up</a>";
            echo '</li>';
          }
          else {
            echo '<li class="nav-item">';
            echo "<a class='nav-link' href='signout.php?prevPage=users.php'>Sign Out</a>";
            echo '</li>';
  ...
  <div class="container-fluid" id='container'>
    <div class="form-group">
      <label for="titleSearch">Search users by username</label>
