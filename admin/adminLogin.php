...
<body>
  <nav class="navbar navbar-expand-xl navbar-light bg-light navbar-fixed-top"  id="navbar">
    <a class="navbar-brand" href="admin.php">ReadHere</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="signup.php?prevPage=<?php if (isset($_GET["prevPage"])) echo $_GET["prevPage"] ; else echo "admin.php"; ?>">Sign Up<span class="sr-only">(current)</span></a>
        </li>
      </ul>
...
<script>
  function authenticate(){
    ...
    var redirect = "<?php if(isset($_GET["prevPage"])) echo $_GET["prevPage"]; else echo "admin.php"; ?>";
